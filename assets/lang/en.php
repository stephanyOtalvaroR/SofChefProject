...
// Login
define('titulo', 'Welcome To SofChef');
define('codigo', 'Code');
...
define('textoIndex1', 'The SofChef System will facilitate the control of raw materials, kitchenware, shrinkage, stock exhaustion alert, for the restaurants that acquire it.');
...
define('text1','SofChefs success is the sum of small efforts that are repeated day after dayskills');
